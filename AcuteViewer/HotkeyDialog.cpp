...
namespace sv {
	...
	HotkeyDialog::HotkeyDialog(std::shared_ptr<QSettings> settings, QWidget* parent)
		...
		QObject::connect(this->strengthSpinBox, SIGNAL(valueChanged(double)), this, SLOT(updateHotkeySettings()));
		...
		QObject::connect(this->radiusSpinBox, SIGNAL(valueChanged(double)), this, SLOT(updateHotkeySettings()));
		...
		QObject::connect(this->sharpeningCheckbox, SIGNAL(stateChanged(int)), this, SLOT(updateHotkeySettings()));
